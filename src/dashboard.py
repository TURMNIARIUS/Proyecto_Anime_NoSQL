"""Dashboard para la exploración del catálogo de animes."""
...
# Módulo del dashboard Streamlit.
#
# Presenta una interfaz interactiva retro/terminal para explorar el
# catálogo de animes, ejecutar análisis y consumir los endpoints de la API.
#
# La función principal `main()` orquesta las vistas y las llamadas al backend.
#
# Requiere que el backend esté accesible en `BACKEND_URL`.
...
def main():
    ...
    Controla el menú lateral y despliega las cuatro vistas principales:
    exploración del catálogo, analítica global, recomendador colaborativo
    y recomendador por contenido.
    """
